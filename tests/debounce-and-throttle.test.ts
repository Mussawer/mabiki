...
describe("debounce and throttle new features", () => {
  [debounce, throttle].forEach((func) => {
    ...
    // Tests if debounce/throttle calls the function immediately when callImmediately option is true
    ...
    // Verifies if debounce/throttle respects the maxCalls option by limiting function invocations
